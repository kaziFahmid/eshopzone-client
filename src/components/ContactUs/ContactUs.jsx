        ...
        <div class="mt-8 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6 mr-2   sm:rounded-lg">
                    <h1 class="text-4xl sm:text-5xl dark:text-white font-semibold tracking-tight">
                        Get in touch
                    </h1>
                ...
                <form class="p-6 flex flex-col justify-center">
                    ...
                    <button type="submit" class="md:w-32 bg-yellow-400 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-yellow-700 transition ease-in-out duration-300">
                        Submit
                    </button>
                </form>
            </div>
