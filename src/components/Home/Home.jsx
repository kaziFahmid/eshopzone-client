...
{products.map((card,index)=> <div key={index} className="relative m-10 mx-auto flex w-full  flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
